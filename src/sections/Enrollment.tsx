...
const questions = [
  ...
  ['Это доказательная медицина?', 'Курс основан на моём практическом опыте, доказательном подходе с применением интегративного и превентивного подхода. В уроках вы найдёте и БАДы, и аптечные лекарственные препараты, которые я применяю на практике.'],
      ...
      <section id="zapis" className="price-section">
        ...
        <div className="price-card">
          ...
          <div className="price-bullets">
            <ul>
              <li>Все уроки: аденоиды, храп, отиты, антибиотики</li>
              <li>3 полезных гайда для мам</li>
              <li>Закрытый TG-канал с полезными подкастами и материалами</li>
            </ul>
            <ul>
              <li>Чек-листы</li>
              <li>Готовые конспекты к каждому уроку, которые останутся с вами</li>
        ...
        <div className="not-here">
          ...
          <ul>
            ...
            <li>Волшебных таблеток и «вылечим всё за неделю»</li>
      ...
      <section id="disclaimer" className="disclaimer-section">
        <div className="disclaimer-card">
          ...
          <div className="disclaimer-sign">
            <span>Доктор Маржанат Омарова</span>
            <img
              src={heartDisclaimer}
              alt=""
