      ...
      <section className="disclaimer-section">
        <div className="disclaimer-card">
          ...
          <p>
            ...
            <span>информация ознакомительного (образовательного) характера,</span>{' '}
            она не заменяет консультацию врача (специалиста).
          </p>
          <p>
          ...
          <div className="disclaimer-sign">
            <span>Ваша Доктор Маржанат</span>
            <img
              src={heartDisclaimer}
              alt=""
              className="disclaimer-heart"
              draggable={false}
            />
          </div>
        </div>
