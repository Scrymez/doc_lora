...
const items: Item[] = [
  ...
  },
  {
    ...
    body: 'Поймёте, когда храп это возрастное, а когда сигнал. Разберём простые шаги, которые можно начать применять уже сегодня.',
  },
  {
    name: 'Частые отиты',
        ...
        {items.map((it, i) => {
          ...
          return (
            <div key={it.name} className={`worry-item rounded-[12px] ${active ? 'is-active' : ''}`}>
              ...
              <div className="worry-panel rounded-b-[12px] border-4 border-t-0 border-accent bg-[#fff3e2] px-4 pb-4 pt-3">
